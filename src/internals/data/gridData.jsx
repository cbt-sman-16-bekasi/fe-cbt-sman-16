...
export const columns = [
  { field: 'token', headerName: 'Token', flex: 1.5, minWidth: 200 },
  {
    field: 'waktuGenerate',
    headerName: 'Waktu Generate',
    flex: 0.5,
    minWidth: 80,
...
export const rows = [
  {
    id: 1,
    token: 'Homepage Overview',
    waktuGenerate: 'Online',
    status: 8345,
    users: 212423,
    viewsPerUser: 18.5,
    averageTime: '2m 15s',
  ...
  {
    id: 3,
    token: 'Checkout Process - Step 1',
    waktuGenerate: 'Offline',
    status: 3455,
    users: 58240,
    viewsPerUser: 15.2,
    averageTime: '2m 10s',
  ...
  {
    id: 5,
    token: 'Article Listing - Tech News',
    waktuGenerate: 'Offline',
    status: 3653,
    users: 142240,
    viewsPerUser: 3.1,
  ...
  {
    id: 7,
    token: 'Product Comparison - Laptops',
    waktuGenerate: 'Offline',
    status: 7853,
    users: 32240,
    viewsPerUser: 6.5,
  ...
  {
    id: 8,
    token: 'Shopping Cart - Electronics',
    waktuGenerate: 'Online',
    status: 8563,
    users: 48240,
    viewsPerUser: 4.3,
  ...
  {
    id: 9,
    token: 'Payment Confirmation - Bank Transfer',
    waktuGenerate: 'Offline',
    status: 4563,
    users: 18240,
    viewsPerUser: 2.7,
  ...
  {
    id: 10,
    token: 'Product Reviews - Smartphones',
    waktuGenerate: 'Online',
    status: 9863,
    users: 28240,
    viewsPerUser: 5.1,
  ...
  {
    id: 11,
    token: 'Subscription Management - Services',
    waktuGenerate: 'Offline',
    status: 6563,
    users: 24240,
    viewsPerUser: 4.8,
  ...
  {
    id: 12,
    token: 'Order Tracking - Shipments',
    waktuGenerate: 'Online',
    status: 12353,
    users: 38240,
    viewsPerUser: 3.5,
  ...
  {
    id: 13,
    token: 'Customer Feedback - Surveys',
    waktuGenerate: 'Offline',
    status: 5863,
    users: 13240,
    viewsPerUser: 2.3,
  ...
  {
    id: 14,
    token: 'Account Settings - Preferences',
    waktuGenerate: 'Online',
    status: 7853,
    users: 18240,
    viewsPerUser: 3.2,
  ...
  {
    id: 15,
    token: 'Login Page - Authentication',
    waktuGenerate: 'Offline',
    status: 9563,
    users: 24240,
    viewsPerUser: 2.5,
  ...
  {
    id: 16,
    token: 'Promotions - Seasonal Sales',
    waktuGenerate: 'Online',
    status: 13423,
    users: 54230,
    viewsPerUser: 7.8,
  ...
  {
    id: 18,
    token: 'Blog Posts - Tech Insights',
    waktuGenerate: 'Online',
    status: 8567,
    users: 34234,
    viewsPerUser: 6.3,
  ...
  {
    id: 21,
    token: 'Case Studies - Success Stories',
    waktuGenerate: 'Offline',
    status: 4567,
    users: 19345,
    viewsPerUser: 6.1,
  ...
  {
    id: 24,
    token: 'Documentation - API Reference',
    waktuGenerate: 'Online',
    status: 6789,
    users: 27689,
    viewsPerUser: 5.0,
  ...
  {
    id: 30,
    token: 'Reports - Monthly Analysis',
    waktuGenerate: 'Online',
    status: 7890,
    users: 34567,
    viewsPerUser: 5.9,
  ...
  {
    id: 31,
    token: 'Training - Employee Onboarding',
    waktuGenerate: 'Offline',
    status: 3456,
    users: 19234,
    viewsPerUser: 6.1,
  ...
  {
    id: 32,
    token: 'Resources - Knowledge Base',
    waktuGenerate: 'Online',
    status: 5678,
    users: 23456,
    viewsPerUser: 4.7,
  ...
  {
    id: 33,
    token: 'Settings - Privacy Controls',
    waktuGenerate: 'Offline',
    status: 6789,
    users: 27689,
    viewsPerUser: 5.8,
  ...
  {
    id: 34,
    token: 'Integrations - Third-Party Services',
    waktuGenerate: 'Online',
    status: 4567,
    users: 19345,
    viewsPerUser: 4.4,
  ...
  {
    id: 35,
    token: 'Account - Billing Information',
    waktuGenerate: 'Offline',
    status: 7890,
    users: 34567,
    viewsPerUser: 5.4,
