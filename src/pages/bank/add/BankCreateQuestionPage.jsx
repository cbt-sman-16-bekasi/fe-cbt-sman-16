...
import {useBankCreateQuestionHook} from "./useBankCreateQuestionHook.js";
...
export function BankCreateQuestionPage({isUpdatePage = false}) {
  const {
...
BankCreateQuestionPage.propTypes = {
