  ...
  return (
    <Dialog open={isOpen} onClose={hideModal} fullWidth maxWidth="xs">
      <Stack sx={{ display: 'flex', alignItems: 'start', justifyContent: 'center', gap: 1, p: 2 }}>
        <TitleWithIcon icon={<Lock sx={{ color: 'white' }} />} text='Ubah Password' iconBackground="red" />
      </Stack>
      ...
      <DialogActions sx={{ px: 3, pb: 2 }}>
        <Button onClick={handleUpdate} variant="contained" fullWidth sx={{ backgroundColor: '#a855f7' }} disabled={!isPasswordValid || isSubmitting}>
